...
export default function Home() {
  return (
    <div className="bg-background relative h-[600px] items-center justify-center overflow-hidden border-b border-dashed">
      <div className="mx-auto flex h-full w-full max-w-5xl flex-col items-center justify-center border-x border-dashed px-20">
        ...
        <div className="z-10 flex flex-col items-center">
          ...
          <h1 className="text-center text-6xl leading-16 font-[900] uppercase">
            Crafting Delightful
            <br />
            Web Experiences
          </h1>
