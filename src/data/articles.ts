import { ArticleItemProps } from '@/components/article-item';

export const ARTICLES: ArticleItemProps[] = [
  {
    title: 'The Easiest Way to Setup Two GitHub Accounts on One System',
    description:
    ...
    link: 'https://blog.axii.xyz/blog/the-easiest-way-to-setup-two-github-accounts-on-one-system',
  },
];
